...
{
  [SerializeField] float _mouseMovement;
  // Hard coded value for mouse sensitivity from before PlayerPrefs was implemented
  //5.0f; //mouse sensitivity of 5
  ...
  private void Update()
  {
    ...
    if (cameraClamp > 90)
    { //clamp for vertical movement of camera -- 90 degrees/-90 degrees
      cameraClamp = 90;
      rotationCamera.x = 90;
    }
